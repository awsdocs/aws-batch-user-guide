# Identity\-based policy examples for AWS Batch<a name="security_iam_id-based-policy-examples"></a>
...
## Using the AWS Batch console<a name="security_iam_id-based-policy-examples-console"></a>
